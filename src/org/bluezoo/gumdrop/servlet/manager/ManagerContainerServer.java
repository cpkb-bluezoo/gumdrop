 ...
 */
public interface ManagerContainerServer {

    /**
     * Returns a collection of the contexts in this container.
     */
    Collection<ManagerContextServer> getContexts();

    /**
     * Returns the context with the given context path.
     */
    ManagerContextServer getContext(String contextPath);
