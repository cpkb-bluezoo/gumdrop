...
import org.bluezoo.gumdrop.servlet.AsyncTimeoutScheduler;
import org.bluezoo.gumdrop.servlet.Container;
import org.bluezoo.gumdrop.servlet.Context;
import org.bluezoo.gumdrop.servlet.RequestHandler;
 ...
 *
 * <p>This server manages a servlet {@link Container} and a bounded pool of
...
public class ServletServer extends HttpServer {
     ...
     */
    public ServletHandlerFactory getServletHandlerFactory() {
