 ...
 */
class ServletInitialContext implements javax.naming.Context, NameParser {
    ...
    ServletInitialContext(Hashtable env) {
    ...
    void bind(String name, String className, Object obj) {
