 ...
 */
public final class ExchangeMethods {

    private ExchangeMethods() {
    }

    /** {@code exchange.declare} (40,10) — sent by the client. */
    public static ByteBuffer encodeDeclare(String exchange, String type, boolean passive,
    ...
    public static void decodeDeclareOk(ByteBuffer payload) {
        // No arguments.
    }

    public static ByteBuffer encodeDeclareOk() {
