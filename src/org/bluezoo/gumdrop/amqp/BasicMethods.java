...
public final class BasicMethods {
    ...
    public static ByteBuffer encodeQos(long prefetchSize, int prefetchCount, boolean global) {
    ...
    public static void decodeQosOk(ByteBuffer payload) {
        // No arguments.
    }

    /** {@code basic.consume} (60,20) — sent by the client. */
    public static ByteBuffer encodeConsume(String queue, String consumerTag, boolean noLocal,
    ...
    public static String decodeConsumeOk(ByteBuffer payload) throws AmqpProtocolException {
        return FieldTable.getShortString(payload);
    }

    public static ByteBuffer encodeConsumeOk(String consumerTag) {
    ...
    public static Consume decodeConsume(ByteBuffer payload) throws AmqpProtocolException {
    ...
    public static ByteBuffer encodeCancel(String consumerTag, boolean noWait) {
    ...
    public static String decodeCancel(ByteBuffer payload) throws AmqpProtocolException {
        String consumerTag = FieldTable.getShortString(payload);
    ...
    public static String decodeCancelOk(ByteBuffer payload) throws AmqpProtocolException {
        return FieldTable.getShortString(payload);
    }

    public static ByteBuffer encodeCancelOk(String consumerTag) {
        int size = 4 + FieldTable.shortStringEncodedSize(consumerTag);
        ByteBuffer buf = ByteBuffer.allocate(size);
        buf.putShort((short) AmqpMethod.CLASS_BASIC);
    ...
    public static ByteBuffer encodePublish(String exchange, String routingKey,
    ...
    public static Publish decodePublish(ByteBuffer payload) throws AmqpProtocolException {
        payload.getShort(); // reserved-1 (ticket)
    ...
    public static Return decodeReturn(ByteBuffer payload) throws AmqpProtocolException {
    ...
    public static Deliver decodeDeliver(ByteBuffer payload) throws AmqpProtocolException {
        String consumerTag = FieldTable.getShortString(payload);
    ...
    public static ByteBuffer encodeDeliver(String consumerTag, long deliveryTag, boolean redelivered,
            String exchange, String routingKey) {
    ...
    public static ByteBuffer encodeGet(String queue, boolean noAck) {
    ...
    public static final class GetOk {
        public final long deliveryTag;
        public final boolean redelivered;
        public final String exchange;
        public final String routingKey;
    ...
    public static GetOk decodeGetOk(ByteBuffer payload) throws AmqpProtocolException {
        long deliveryTag = payload.getLong();
        boolean redelivered = AmqpBits.unpack(payload.get(), 0);
        String exchange = FieldTable.getShortString(payload);
        String routingKey = FieldTable.getShortString(payload);
    ...
    public static void decodeGetEmpty(ByteBuffer payload) throws AmqpProtocolException {
        FieldTable.getShortString(payload); // reserved-1, discarded
    }

    /** {@code basic.ack} (60,80) — sent by either peer. */
    public static ByteBuffer encodeAck(long deliveryTag, boolean multiple) {
    ...
    public static Ack decodeAck(ByteBuffer payload) {
        long deliveryTag = payload.getLong();
    ...
    public static ByteBuffer encodeReject(long deliveryTag, boolean requeue) {
        ByteBuffer buf = ByteBuffer.allocate(4 + 8 + 1);
        buf.putShort((short) AmqpMethod.CLASS_BASIC);
    ...
    public static ByteBuffer encodeNack(long deliveryTag, boolean multiple, boolean requeue) {
        ByteBuffer buf = ByteBuffer.allocate(4 + 8 + 1);
        buf.putShort((short) AmqpMethod.CLASS_BASIC);
    ...
    public static Nack decodeNack(ByteBuffer payload) {
        long deliveryTag = payload.getLong();
        byte bits = payload.get();
    ...
    public static ByteBuffer encodeRecover(boolean requeue) {
    ...
    public static void decodeRecoverOk(ByteBuffer payload) {
        // No arguments.
    }
}
