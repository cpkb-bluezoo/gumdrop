 ...
 */
public final class QueueMethods {

    private QueueMethods() {
    }

    /** {@code queue.declare} (50,10) — sent by the client. */
    public static ByteBuffer encodeDeclare(String queue, boolean passive, boolean durable,
    ...
    public static final class DeclareOk {
        public final String queue;
        public final long messageCount;
        public final long consumerCount;
    ...
    public static DeclareOk decodeDeclareOk(ByteBuffer payload) throws AmqpProtocolException {
    ...
    public static ByteBuffer encodeDeclareOk(String queue, long messageCount, long consumerCount) {
    ...
    public static Declare decodeDeclare(ByteBuffer payload) throws AmqpProtocolException {
    ...
    public static ByteBuffer encodeBind(String queue, String exchange, String routingKey,
    ...
    public static void decodeBindOk(ByteBuffer payload) {
        // No arguments.
    }

    public static ByteBuffer encodeBindOk() {
    ...
    public static Bind decodeBind(ByteBuffer payload) throws AmqpProtocolException {
        payload.getShort(); // reserved-1 (ticket)
        String queue = FieldTable.getShortString(payload);
