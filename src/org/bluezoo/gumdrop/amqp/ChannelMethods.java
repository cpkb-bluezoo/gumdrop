 ...
 */
public final class ChannelMethods {

    private ChannelMethods() {
    }

    /** {@code channel.open} (20,10) — sent by the client. */
    public static ByteBuffer encodeOpen() {
    ...
    public static void decodeOpen(ByteBuffer payload) throws AmqpProtocolException {
    ...
    public static boolean decodeFlow(ByteBuffer payload) {
        return AmqpBits.unpack(payload.get(), 0);
    }

    public static ByteBuffer encodeFlow(boolean active) {
    ...
    public static boolean decodeFlowOk(ByteBuffer payload) {
        return AmqpBits.unpack(payload.get(), 0);
    }

    public static ByteBuffer encodeFlowOk(boolean active) {
        ByteBuffer buf = ByteBuffer.allocate(5);
        buf.putShort((short) AmqpMethod.CLASS_CHANNEL);
    ...
    public static ConnectionMethods.CloseReason decodeClose(ByteBuffer payload) throws AmqpProtocolException {
