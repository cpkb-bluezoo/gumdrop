...
/**
 * Receives {@code confirm.select-ok}: the channel is now in publisher
 * confirm mode. From this point, every {@link ClientChannel#basicPublish}
 * on the channel is assigned a 1-based sequence number (see {@link
 ...
 */
public interface ConfirmSelectHandler {
