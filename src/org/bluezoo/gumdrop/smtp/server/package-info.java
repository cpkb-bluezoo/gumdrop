...
/**
 * SMTP server: listeners, session composition SPI, and staged handler/state
 * interfaces (RFC 5321).
 *
 * <p>{@link SmtpServer} implements {@link SmtpServerSessionProvider}
 * ({@link org.bluezoo.gumdrop.ServerSessionProvider}), which mints a fresh
 * pipeline per accepted connection; {@link ClientConnected} is the entry
 * stage. Stateless protocols (HTTP, DNS) compose with request/query
 * handlers instead.
 *
