 ...
 * handler pipeline. Pass an implementation directly to {@link
 ...
 * <pre>{@code
 * public class MyMailHandler implements RemoteGreeting {
 *     
 ...
 */
public interface RemoteGreeting extends ClientHandler {
