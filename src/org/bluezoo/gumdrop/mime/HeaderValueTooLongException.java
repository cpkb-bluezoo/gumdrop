/*
 * HeaderValueTooLongException.java
...
/**
 * Exception indicating that an unfolded header value exceeded the maximum
 * permitted size. Used to prevent unbounded buffer allocation from folded
 * header lines (RFC 5322 allows folding; receivers may enforce limits).
 *
