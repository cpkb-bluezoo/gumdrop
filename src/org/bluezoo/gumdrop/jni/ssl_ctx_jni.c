...
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1new(
...
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1load_1cert_1chain(
...
JNIEXPORT jint JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1load_1priv_1key(
        JNIEnv *env, jclass cls, jlong ctx_ptr, jstring path) {
    SSL_CTX *ctx = (SSL_CTX *)(intptr_t)ctx_ptr;
    const char *c_path = (*env)->GetStringUTFChars(env, path, NULL);
...
JNIEXPORT jint JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1load_1verify_1locations(
        JNIEnv *env, jclass cls, jlong ctx_ptr, jstring path) {
    SSL_CTX *ctx = (SSL_CTX *)(intptr_t)ctx_ptr;
    const char *c_path = (*env)->GetStringUTFChars(env, path, NULL);
...
JNIEXPORT jint JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1set_1ciphersuites(
...
JNIEXPORT jint JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1set_1groups(
...
JNIEXPORT jint JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1set_1alpn_1protos(
...
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1set_1verify_1peer(
...
JNIEXPORT jlong JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1new(
...
JNIEXPORT void JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1set_1hostname(
...
JNIEXPORT void JNICALL
Java_org_bluezoo_gumdrop_GumdropNative_ssl_1ctx_1free(
        JNIEnv *env, jclass cls, jlong ctx_ptr) {
    SSL_CTX *ctx = (SSL_CTX *)(intptr_t)ctx_ptr;
    SSL_CTX_free(ctx);
}
