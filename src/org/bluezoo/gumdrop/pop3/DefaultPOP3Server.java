...
/**
 * Default POP3 service that accepts all operations using the
 * configured Realm and MailboxFactory.
 *
 * <p>This service creates {@link DefaultPOP3Handler} instances for
 ...
 * <pre>{@code
 * <service class="org.bluezoo.gumdrop.pop3.DefaultPOP3Server">
 ...
 */
public class DefaultPOP3Server extends Pop3Server {
