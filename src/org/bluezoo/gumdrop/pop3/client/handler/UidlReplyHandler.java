 ...
 * @see ClientTransactionState#uidl(UidlReplyHandler)
 * @see ClientTransactionState#uidl(int, UidlReplyHandler)
 */
public interface UidlReplyHandler extends ReplyHandler {
