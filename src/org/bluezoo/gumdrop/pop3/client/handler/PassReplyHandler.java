 ...
 *
 * <p>On success, the handler enters the TRANSACTION state and can access
 * the mailbox. On failure, the handler returns to the AUTHORIZATION state.
 *
 * @author <a href='mailto:dog@gnu.org'>Chris Burdess</a>
 * @see ClientPasswordState#pass
 * @see ClientTransactionState
 */
public interface PassReplyHandler extends ReplyHandler {

    /**
     * Called when authentication succeeds (+OK).
     *
     * <p>The mailbox is now open and the handler can issue TRANSACTION
     * commands.
     *
