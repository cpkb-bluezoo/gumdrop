...
public interface ClientAuthExchange {
     ...
     *
     * <p>The response bytes will be base64 encoded by the connection
     * before sending to the server. The callback receives the server's
     * next response, which may be another challenge, success, or failure.
     *
     ...
     *
     * <p>Sends "*" to the server to cancel the SASL exchange. Use this
     * if the handler cannot compute a valid response or wants to try a
