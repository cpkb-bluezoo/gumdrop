...
/**
 * Stateless, static-table-only QPACK header decoder (RFC 9204).
 *
 * <p>{@link Decoder} is the real decoder, and understands the dynamic
 * table -- this one exists as a simple, dependency-free building block.
 * A field section whose Required Insert Count is not 0, or that
 * contains any representation referencing the dynamic table (a
 * {@code T=0} indexed field line or name reference, or either post-Base
