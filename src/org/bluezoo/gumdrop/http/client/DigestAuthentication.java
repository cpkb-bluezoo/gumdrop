...
public class DigestAuthentication implements HTTPAuthentication {
    ...
    private String calculateResponse(String method, String uri, String nonceCount, String cnonce) {
        try {
            ...
            String ha1 = bytesToHex(md.digest(a1.getBytes(StandardCharsets.UTF_8)));
            
            // Calculate H(A2) = H(method:uri)
            String a2 = method + ":" + uri;
            String ha2 = bytesToHex(md.digest(a2.getBytes(StandardCharsets.UTF_8)));
            ...
            return bytesToHex(md.digest(responseData.getBytes(StandardCharsets.UTF_8)));
