...
/**
 * Handler for PWD command response. RFC 959 §4.1.3.
 *
 * @author <a href='mailto:dog@gnu.org'>Chris Burdess</a>
 * @see ClientAuthenticatedState#pwd
 */
public interface ServerPwdReplyHandler extends ServerReplyHandler {

    /**
     * Called when the server returns the current working directory (257).
     *
     * @param pathname the current working directory, with the
