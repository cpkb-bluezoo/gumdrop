...
/**
 * Handler for EPSV command response. RFC 2428 §3.
 *
 * <p>Unlike PASV, the EPSV reply carries only a port — the address is the
 * same host the control connection is already talking to.
 *
 * @author <a href='mailto:dog@gnu.org'>Chris Burdess</a>
 * @see ClientAuthenticatedState#epsv
 */
public interface ServerEpsvReplyHandler extends ServerReplyHandler {

    /**
     * Called when the server enters extended passive mode (229).
     *
     * @param dataAddress the address to connect the data connection to
     *      (the control connection's remote host, with the announced port)
