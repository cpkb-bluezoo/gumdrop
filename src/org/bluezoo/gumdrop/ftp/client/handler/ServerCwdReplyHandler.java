...
/**
 * Handler for CWD command response. RFC 959 §4.1.3.
 *
 * @author <a href='mailto:dog@gnu.org'>Chris Burdess</a>
 * @see ClientAuthenticatedState#cwd
 */
public interface ServerCwdReplyHandler extends ServerReplyHandler {

    /**
     * Called when the server changes the working directory (250).
     *
    ...
    /**
     * Called when the server rejects the command (4xx/5xx, e.g. no such
     * directory).
     *
     * @param authenticated operations available for further commands
