...
/**
 * IMAP server: listeners, session composition SPI, and staged handler
 * interfaces for the IMAP4rev2 server (RFC 9051).
 *
 * <p>{@link ImapServer} is the canonical server type — configure it with
 * {@link ImapServer#compose()}; do not subclass it for application logic.
 *
