 ...
 * 
 * <p>This interface is provided to {@link SelectedHandler#status} and
 * allows the handler to proceed with the status query or deny it.
 * 
 * @author <a href='mailto:dog@gnu.org'>Chris Burdess</a>
 * @see SelectedHandler#status
 */
public interface SelectedStatusState {
     ...
     * @param handler continues receiving selected commands
     */
    void mailboxNotFound(SelectedHandler handler);
