 ...
 * @see AppendDataHandler#appendComplete
 */
public interface AppendCompleteState {
     ...
     */
    void appended(AuthenticatedHandler handler);

    /**
     * Message appended with APPENDUID response code.
     * 
     * @param uidValidity the mailbox UID validity
     * @param uid the UID of the appended message
     * @param handler continues receiving authenticated commands
     */
    void appendedWithUid(long uidValidity, long uid, AuthenticatedHandler handler);
