 ...
 * @see SelectedHandler#copy
 * @see SelectedHandler#uidCopy
 */
public interface CopyState {
     ...
     */
    void copied(SelectedHandler handler);
     ...
     * @param handler continues receiving selected commands
     */
    void copiedWithUid(long uidValidity, String sourceUids, String destUids, 
     ...
     * @param handler continues receiving selected commands
     */
    void copyFailed(String message, SelectedHandler handler);
