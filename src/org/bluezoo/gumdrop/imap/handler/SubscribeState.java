 ...
 * @see AuthenticatedHandler#subscribe
 * @see AuthenticatedHandler#unsubscribe
 */
public interface SubscribeState {
     ...
     */
    void subscribed(AuthenticatedHandler handler);
     ...
     * @param handler continues receiving authenticated commands
     */
    void subscribeFailed(String message, AuthenticatedHandler handler);
