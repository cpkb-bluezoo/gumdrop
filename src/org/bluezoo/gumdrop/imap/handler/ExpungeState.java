 ...
 * @see SelectedHandler#expunge
 * @see SelectedHandler#uidExpunge
 */
public interface ExpungeState {
     ...
     * 
     * @param sequenceNumber the sequence number of the expunged message
     */
     ...
     */
    void expungeComplete(SelectedHandler handler);
     ...
     * @param handler continues receiving selected commands
     */
    void expungeFailed(String message, SelectedHandler handler);
