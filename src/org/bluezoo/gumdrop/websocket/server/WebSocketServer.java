...
import org.bluezoo.gumdrop.websocket.Http3WebSocketListener;
...
/**
 * Abstract base for WebSocket protocol servers.
 *
 * <p>A {@code WebSocketServer} provides a pure WebSocket programming
 ...
 *
 * <p>The servlet container ({@code ServletServer}) provides its own
 * WebSocket upgrade path via {@code HttpServletRequest.upgrade()}.
 * Both this server and the servlet container share the same
 ...
 * @see org.bluezoo.gumdrop.Server
...
public abstract class WebSocketServer implements Server {
     ...
     */
    public abstract WebSocketEventHandler createConnectionHandler(
            String requestPath, Headers upgradeHeaders);
     ...
     */
    public String selectSubprotocol(Headers upgradeHeaders) {
        return null;
    }
