...
public class WebSocketHandshake {
    ...
    /**
     * Generates a random Sec-WebSocket-Key value for a client handshake.
     *
     * <p>The key is a 16-byte random value, Base64-encoded, as required
     * by RFC 6455 Section 4.1.
     *
    ...
    /**
     * Creates the HTTP request headers for a WebSocket upgrade request.
     *
     * <p>Generates the required headers for a client-initiated WebSocket
     * upgrade:
     * <ul>
     * <li><code>Upgrade: websocket</code></li>
     * <li><code>Connection: Upgrade</code></li>
     * <li><code>Sec-WebSocket-Version: 13</code></li>
     * <li><code>Sec-WebSocket-Key: &lt;key&gt;</code></li>
     * <li><code>Sec-WebSocket-Protocol: &lt;subprotocol&gt;</code> (if specified)</li>
     * </ul>
     *
    ...
    /**
     * Validates a server's WebSocket upgrade response.
     *
     * <p>Checks the 101 Switching Protocols response headers:
     * <ul>
     * <li><code>Upgrade</code> header contains "websocket" (case-insensitive)</li>
     * <li><code>Connection</code> header contains "Upgrade" (case-insensitive)</li>
     * <li><code>Sec-WebSocket-Accept</code> matches the expected value
     *     computed from the sent key</li>
     * </ul>
     *
