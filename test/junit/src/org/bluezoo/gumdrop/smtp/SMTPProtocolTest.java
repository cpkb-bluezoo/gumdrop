...
public class SMTPProtocolTest {
    ...
    public void testCompleteEmailTransaction() {
        ...
        try {
            ...
            sharedConnection.received(buffer);
            Thread.sleep(20);
    ...
    public void testFragmentedCommands() {
        ...
        try {
            ...
            connection.received(part1);
            Thread.sleep(5);
            connection.received(part2);
            Thread.sleep(5);
            connection.received(part3);
            Thread.sleep(15);
    ...
    private static class TestSMTPHandler implements SMTPConnectionHandler {
        ...
        public void connected(SMTPConnectionMetadata metadata) {
            // Connection established - no action needed for test
        }
        
        @Override
        public SenderPolicyResult mailFrom(String senderAddress, SMTPConnectionMetadata metadata) {
            // Accept all senders for testing
            return SenderPolicyResult.ACCEPT;
        }
        
        @Override
        public RecipientPolicyResult rcptTo(String recipientAddress, SMTPConnectionMetadata metadata) {
            // Accept all recipients for testing
            return RecipientPolicyResult.ACCEPT;
        }
        
        @Override
        public void messageContent(ByteBuffer messageData, SMTPConnectionMetadata metadata) {
            // Accept all message content for testing
        }
        
        public void transactionReset(SMTPConnectionMetadata metadata) {
            // Transaction reset - no action needed for test
        }
        
        @Override
        public void reset(SMTPConnectionMetadata metadata) {
            // Reset - no action needed for test
        }
        
        @Override
        public void disconnected(SMTPConnectionMetadata metadata) {
