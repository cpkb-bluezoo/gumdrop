...
public class HTTPProtocolTest {
    ...
    public void testFragmentedRequest() {
        ...
        try {
            ...
            conn.received(ByteBuffer.wrap(part1.getBytes(StandardCharsets.UTF_8)));
            Thread.sleep(10);
            conn.received(ByteBuffer.wrap(part2.getBytes(StandardCharsets.UTF_8)));
            Thread.sleep(10);
            conn.received(ByteBuffer.wrap(part3.getBytes(StandardCharsets.UTF_8)));
            Thread.sleep(10);
            conn.received(ByteBuffer.wrap(part4.getBytes(StandardCharsets.UTF_8)));
            Thread.sleep(50);
